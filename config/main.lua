...
Config.Database = {
    ...
    -- مهلة انتظار جاهزية oxmysql قبل البدء في وضع متدهور.
    ReadyTimeoutMs = 30000,

    -- مهلة اختبار الاتصال الفعلي:
    -- SELECT 1
    QueryTestTimeoutMs = 5000,
...
Config.Logs = {
    ...
    -- أقصى عدد لوجات يمكن الاحتفاظ بها في الذاكرة المؤقتة
    -- قبل الحفظ أو التنظيف.
    MaxBuffer = 100,
